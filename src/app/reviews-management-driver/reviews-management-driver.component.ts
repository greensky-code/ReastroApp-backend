...
@Component({
  selector: 'app-reviews-management-driver',
  templateUrl: './reviews-management-driver.component.html',
  styleUrls: ['./reviews-management-driver.component.css']
})
export class ReviewsManagementDriverComponent implements OnInit {
  cousins_list: any = [];
  limit: any = 10;
  page = 1;
  tabView: any = 'drivers';
