...
@Component({
  selector: 'app-edit-restaurant-item-details',
  templateUrl: './edit-restaurant-item-details.component.html',
  styleUrls: ['./edit-restaurant-item-details.component.css']
})
export class EditRestaurantItemDetailsComponent implements OnInit {
  cousins_list: any = [];
  limit: any = 10;
  page = 1;
