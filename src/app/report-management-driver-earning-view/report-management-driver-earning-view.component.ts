...
@Component({
  selector: 'app-report-management-driver-earning-view',
  templateUrl: './report-management-driver-earning-view.component.html',
  styleUrls: ['./report-management-driver-earning-view.component.css']
})
export class ReportManagementDriverEarningViewComponent implements OnInit {
  cousins_list: any = [];
  limit: any = 10;
  page = 1;
