...
declare var $:any;
@Component({
  selector: 'app-restaurent-payout-history',
  templateUrl: './restaurent-payout-history.component.html',
  styleUrls: ['./restaurent-payout-history.component.css']
})
export class RestaurentPayoutHistoryComponent implements OnInit {
  cousins_list: any = [];
  limit: any = 10;
  page = 1;
