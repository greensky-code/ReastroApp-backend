...
@Component({
  selector: 'app-report-management-restaurent-earning',
  templateUrl: './report-management-restaurent-earning.component.html',
  styleUrls: ['./report-management-restaurent-earning.component.css']
})
export class ReportManagementRestaurentEarningComponent implements OnInit {
  cousins_list: any = [];
  limit: any = 10;
  page = 1;
