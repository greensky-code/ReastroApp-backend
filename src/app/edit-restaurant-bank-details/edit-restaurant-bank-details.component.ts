...
@Component({
  selector: 'app-edit-restaurant-bank-details',
  templateUrl: './edit-restaurant-bank-details.component.html',
  styleUrls: ['./edit-restaurant-bank-details.component.css']
})
export class EditRestaurantBankDetailsComponent implements OnInit {
  cousins_list: any = [];
  limit: any = 10;
  page = 1;
