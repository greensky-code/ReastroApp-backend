...
declare var $:any;
@Component({
  selector: 'app-edit-restaurant-company-details',
  templateUrl: './edit-restaurant-company-details.component.html',
  styleUrls: ['./edit-restaurant-company-details.component.css']
})
export class EditRestaurantCompanyDetailsComponent implements OnInit {
  cousins_list: any = [];
  limit: any = 10;
  page = 1;
