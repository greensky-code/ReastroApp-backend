...
declare var $:any;
@Component({
  selector: 'app-total-earning-report',
  templateUrl: './total-earning-report.component.html',
  styleUrls: ['./total-earning-report.component.css']
})
export class TotalEarningReportComponent implements OnInit {
  cousins_list: any = [];
  limit: any = 10;
  page = 1;
