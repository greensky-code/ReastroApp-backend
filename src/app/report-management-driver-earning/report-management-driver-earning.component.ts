...
@Component({
  selector: 'app-report-management-driver-earning',
  templateUrl: './report-management-driver-earning.component.html',
  styleUrls: ['./report-management-driver-earning.component.css']
})
export class ReportManagementDriverEarningComponent implements OnInit {
  cousins_list: any = [];
  limit: any = 10;
  page = 1;
