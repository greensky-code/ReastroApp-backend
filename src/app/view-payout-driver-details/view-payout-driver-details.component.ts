...
@Component({
  selector: 'app-view-payout-driver-details',
  templateUrl: './view-payout-driver-details.component.html',
  styleUrls: ['./view-payout-driver-details.component.css']
})
export class ViewPayoutDriverDetailsComponent implements OnInit {
  payout_data: any;
  driverPayout_id: any;
