...
@Component({
  selector: 'app-payout-history-driver',
  templateUrl: './payout-history-driver.component.html',
  styleUrls: ['./payout-history-driver.component.css']
})
export class PayoutHistoryDriverComponent implements OnInit {
  cousins_list: any = [];
  limit: any = 10;
  page = 1;
  tabView: any = 'drivers';
