...
declare var $:any;
@Component({
  selector: 'app-report-management-driver-rating',
  templateUrl: './report-management-driver-rating.component.html',
  styleUrls: ['./report-management-driver-rating.component.css']
})
export class ReportManagementDriverRatingComponent implements OnInit {
  cousins_list: any = [];
  limit: any = 10;
  page = 1;
