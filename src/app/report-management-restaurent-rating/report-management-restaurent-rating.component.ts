...
declare var $:any;
@Component({
  selector: 'app-report-management-restaurent-rating',
  templateUrl: './report-management-restaurent-rating.component.html',
  styleUrls: ['./report-management-restaurent-rating.component.css']
})
export class ReportManagementRestaurentRatingComponent implements OnInit {
  cousins_list: any = [];
  limit: any = 10;
  page = 1;
