...
@Component({
  selector: 'app-report-management-restaurant-view',
  templateUrl: './report-management-restaurant-view.component.html',
  styleUrls: ['./report-management-restaurant-view.component.css']
})
export class ReportManagementRestaurantViewComponent implements OnInit {
  cousins_list: any = [];
  limit: any = 10;
  page = 1;
