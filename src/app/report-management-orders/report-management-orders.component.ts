...
@Component({
  selector: 'app-report-management-orders',
  templateUrl: './report-management-orders.component.html',
  styleUrls: ['./report-management-orders.component.css']
})
export class ReportManagementOrdersComponent implements OnInit {
  cousins_list: any = [];
  limit: any = 10;
  page = 1;
